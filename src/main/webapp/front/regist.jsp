...
<img style="height:280px;padding-top:10px;display:block;" src="frontImages/book/22632572-1_u_1.jpg" />
 ...
 <h1 style="font-size:12px;color:#666;padding-left:450px;"><span>新用户注册</span></h1>
<form  id="formLogin" action="reg.do" method="post" >
    <div class="loginDiv">
        <input name="name" type="text" class="logininput" id="name" placeholder="用户名"/>
        <span id="nameTip"></span>
    </div>
    <div class="loginDiv">
        <input name="pwd" type="text" class="logininput" id="pwd"  placeholder="密码"/>
    </div>
    <div class="loginDiv">
        <input name="repwd" type="text" class="logininput" id="repwd"  placeholder="确认密码"/>
        <span id="pwdTip"></span>
    </div>
  <div class="loginDiv">
