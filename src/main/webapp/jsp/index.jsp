...
<title>传智商城</title>
<link href="${pageContext.request.contextPath}/css1/slider.css" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/css1/common.css" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/css1/index.css" rel="stylesheet" type="text/css"/>
</head>
<body>
	...
	<div class="span5">
		<div class="logo">
			<a href="./京华亿家/index.htm">
				<img src="${pageContext.request.contextPath}/frontimage/r___________renleipic_01/logo.gif" alt="传智播客"/>
			</a>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
	<img src="${pageContext.request.contextPath}/frontimage/header.jpg" width="320" height="50" alt="正品保障" title="正品保障"/>
</div>	
</div>
