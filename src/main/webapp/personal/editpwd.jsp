...
<div id="content"  >
 ...
 <h1 style="font-size:12px;color:#666;padding-left:450px;"><span>用户密码修改</span></h1>
<form  id="formLogin" action="reset.do" method="post" >

<br/>
<div class="loginDiv">
 <div class="loginDiv">
 <input name="oldPWD" type="text" class="logininput" placeholder="原密码" />
 </div>
 
 <div class="loginDiv">
 <input name="newPWD" type="text" class="logininput" placeholder="新密码" />
 </div>
    <div class="loginDiv">

        <input name="renewPWD" type="text" class="logininput"  placeholder="确认新密码" />
    </div>
  <div class="loginDiv">
 <input name="submit" type="submit" class="btn_grey first" value="确定" />
<input name="reset" type="reset" class="btn_grey" value="重置"/>
</div>
</form>
<p id="immedate_register" style="padding-top:10px;">
<a style="float:right;color:#666;padding-right:150px;" href="#">立即注册</a>
...
<div style="text-align:center;">
		<p class="p1"> </p>
		<p class="p2">江西师大软件学院, Copyright © 2008&nbsp; | Privacy Notice 
		| Terms of Use </p>
</div>
</body>
</html>
