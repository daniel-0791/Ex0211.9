...
<meta http-equiv="refresh" content="2;url=<%=basePath%>personal/editpwd.jsp"/>
<title>CSS图书商城</title>
<style type="text/css">
#share_login {
  float:right;
...
<img style="height:280px;padding-top:10px;display:block;" src="frontImages/book/22632572-1_u_1.jpg" />
 ...
 <h1 style="font-size:12px;color:#666;padding-left:450px;"><span>登录到图书商城</span></h1>
${loginName}用户密码有误，请重新设置！2秒后自动跳转到登录页面，如果无法跳转，请单击<a href="personal/editpwd.jsp">密码重置</a></div>
